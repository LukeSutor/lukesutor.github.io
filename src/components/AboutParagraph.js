...
export default function AboutParagraph(props) {
  ...
  const aboutParagraphs = [
    <p>I'm Luke Sutor, a 19 year-old Sophomore at the University of Florida studing computer science through the Herbert Wertheim College of Engineering.</p>,
    <p className="py-6">I began programming when I enrolled in the CS program at my high school, Suncoast Community High School, and have been creating projects ever since.</p>,
